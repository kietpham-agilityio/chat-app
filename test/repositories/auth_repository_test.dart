...
//     //   when(() => mockSnapshot.id).thenReturn('uid123');
...
//   group('getUserData', () {
//     // test('returns right(UserModel) when user exists', () async {
//     //   final mockSnapshot = MockDocumentSnapshot();
//     //   final mockCollection = MockCollectionReference();
//     //   final mockDoc = MockDocumentReference();
...
//     test('returns right(Unit) when successful with no avatar', () async {
//       final mockCollection = MockCollectionReference();
//       final mockDoc = MockDocumentReference();
...
//       when(() => mockQueryDoc.id).thenReturn('room1');
//       when(() => mockCollection.doc('room1')).thenReturn(mockDoc);
//       when(() => mockDoc.update(any())).thenAnswer((_) async => {});

//       final result = await repository.updateUserData(
//         user: UserModel(
//           uid: 'uid123',
//           fullName: 'Test',
//           email: 'a@b.com',
...
void main() {
  ...
  group('signOut', () {
    // test('returns right(Unit) when successful', () async {
